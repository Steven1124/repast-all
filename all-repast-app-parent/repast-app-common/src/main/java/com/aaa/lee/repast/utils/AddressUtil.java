 ...
 *         http://api.map.baidu.com/location/ip?ak=QKQij03yirtuRnkQDV06rCRGoGoIVjNM&ip=220.137.210.39&coor=bd09ll
 *
 **/
public class AddressUtil {
    ...
    **/
    public static Map<String, Object> getAddresses(String content, String encodingString) {
        // 这里调用百度API
        String urlStr = "http://api.map.baidu.com/location/ip?ak=QKQij03yirtuRnkQDV06rCRGoGoIVjNM&ip="+content+"&coor=bd09ll";
    ...
    **/
    ...
    public static void main(String[] args) throws Exception {
        Map<String, Object> addresses = AddressUtil.getAddresses("220.137.210.39", "UTF-8");

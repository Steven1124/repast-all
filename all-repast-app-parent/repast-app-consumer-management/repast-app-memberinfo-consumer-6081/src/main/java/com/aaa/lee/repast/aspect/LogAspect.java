...
public class LogAspect {
    ...
    **/
    ...
    public Object around(ProceedingJoinPoint proceedingJoinPoint) throws Exception {
        ...
        // 在member对象中
        // loginLog.setProvince(); // 省份信息
        loginLog.setLoginType(3);// 登录类型(3:小程序)
        // loginLog.setCity();// 城市信息
